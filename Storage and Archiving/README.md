...
|----------|--------------|------|
| **EBS (Elastic Block Store)** | Persistent block storage for EC2, including volume creation, attachment, snapshots, and restoration. | [Go to EBS Lab](./EBS/aws-ebs-lab.md) |
